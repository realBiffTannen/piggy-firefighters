...
const directories = ['apps/piggy_firefighters/src/game/anim','apps/piggy_firefighters/src/components/rigs','apps/piggy_firefighters/src/routes/rigs'];
...
if(diagnostics.length) {
 ...
 process.exitCode=1;
} else console.log(`PASS: ${ownFiles.length} runtime source files; Svelte compilation and scoped TypeScript diagnostics clear.`);
