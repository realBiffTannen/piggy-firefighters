<script lang="ts">
  import { BaseSpineProvider, createContextParent, type PIXI, type LoadedSpine } from 'pixi-svelte';
...
<BaseSpineProvider spineData={props.data} autoUpdate={false} eventMode="none">
  <ViewerPlayback {...props} />
</BaseSpineProvider>
