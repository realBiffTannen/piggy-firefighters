...
const primaryMachines = createPrimaryMachines<Bet>({
	...
	onNewGameStart: async () => {
		// Guarantee any interrupted feature (Rescue / Inferno / Backdraft Spins / Alarm Call) releases its HUD win
		// ownership and feature-spins, and the scene is Station 13 again, before a new round begins.
		teardownFeature();
