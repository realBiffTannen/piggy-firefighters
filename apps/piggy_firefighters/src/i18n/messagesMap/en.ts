export default {
	HOME: 'HOME',
	// player title (game/names.ts GAME_TITLE is the code constant; app.html / +layout <title> say the same)
	GAME_TITLE: 'PIGGY FIREFIGHTERS',
	...
	// added here wins over it. Every SPLASH_* key is defined there.
};
