...
def main():
    ...
    ap.add_argument("--land", default="%dx%d" % LAND, help="environment landscape size (the runtime cover-fits any size; 2039x1000 is the delivered plate)")
    ap.add_argument("--port", default="%dx%d" % PORT, help="environment portrait size (the runtime cover-fits any size; 1242x2208 is the delivered plate)")
