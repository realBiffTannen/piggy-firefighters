...
export const preloadFont = () =>
	// No external web-font fetch. Stake approval requires CDN-only assets with no
	// external origins; the previous Typekit (use.typekit.net) load is removed and
	// UI text falls back to the system font stack set on <body> in app.html.
	Promise.resolve();
