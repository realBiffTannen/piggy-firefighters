...
export interface components {
	schemas: {
		...
		ConfigObject: {
			betLevels?: number[];
			/** @description Smallest bet the operator accepts, in API units. */
			minBet?: number;
			/** @description Largest bet the operator accepts, in API units. */
			maxBet?: number;
			/** @description Granularity a custom bet amount must sit on, in API units. */
			stepBet?: number;
			betModes?: {
