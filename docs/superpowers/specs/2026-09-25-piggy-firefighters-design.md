...
| Frontend (engine, scenes, HUD glue, copy, rules, rig mounting slots + `animBeat` emission) | Claude | `apps/piggy_firefighters/**` except `static/assets/spine/**`, `src/game/anim/**`, `src/components/rigs/**`, `src/routes/rigs/**`, `packages/**`, `server/**`, `game/**`, `tools/**` except `tools/codex/**` |
...
| Spine rigs (part cutting from Claude's masters, rigging, export, checker) + rig RUNTIME (PF-20260925-03) | **Codex** (per `docs/ANIMATION_CONTRACT.md` v1.1) | `art-src/animation/rigs/**`, `art-src/animation/tools/**`, `apps/piggy_firefighters/static/assets/spine/**`, `apps/piggy_firefighters/src/game/anim/**`, `apps/piggy_firefighters/src/components/rigs/**`, `apps/piggy_firefighters/src/routes/rigs/**` |
